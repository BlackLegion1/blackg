...
<body>
    ...
    <?php foreach ($productos as $producto): ?>
        ...
        ?>
            <img src="<?= $imagen ?>" alt="<?= htmlspecialchars($producto['nombre']) ?>" style="width: 50px; height: 50px;">
            <strong><?= htmlspecialchars($producto['nombre']) ?></strong> - $<?= number_format($producto['precio'], 2) ?>
